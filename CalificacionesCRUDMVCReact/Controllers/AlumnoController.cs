...
using CalificacionesCRUDMVCReact.Models;
using Microsoft.EntityFrameworkCore;

namespace CalificacionesCRUDMVCReact.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AlumnoController : ControllerBase
    {
        private readonly CalificacionesMvcContext _dbcontext;
        public AlumnoController(CalificacionesMvcContext context)
        {
            _dbcontext = context;
        }
        [HttpGet]
